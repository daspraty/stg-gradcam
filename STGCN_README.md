...
<!--python tools/ntu_gendata.py --data_path /home/pratyusha/Pratyusha_workspace/project/src/office/AS-GCN/data/NTU-RGB+D/nturgb+d_skeletons -->
...
self.model.st_gcn_networks[0].relu
