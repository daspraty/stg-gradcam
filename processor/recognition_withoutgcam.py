...
class REC_Processor(Processor):
    ...
    def test(self, evaluation=True):
        ...
        #     wt=self.model.st_gcn_networks[layer].tcn[2].weight
        #
        #     wt=wt.data.cpu().numpy()
        #     wght[layer]=np.squeeze(wt).tolist()
            # print(wt[0,0,:])

        # with open("weight.json", "w") as outfile:
        #     json.dump(wght, outfile)


        # savemat('stgcn_temporal_weights.mat', wght)
